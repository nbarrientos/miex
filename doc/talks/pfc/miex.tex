...
% 18 de Septiembre de 2007 - Gijón                            %
%                                                             %
% Licencia GNU GPL2                                           %
...
\frame
{
  ...
  \begin{block}{Estudio}<2->
    \begin{itemize}
      ...
      \item<3- | alert@3> Posible ampliación
      \item<4- | alert@4-> ¿Para este uso en concreto?
    \end{itemize}
  \end{block}
  \end{center}
}
...
\frame
{
  \frametitle{Líneas de trabajo (I)}
...
\frame
{
  \frametitle{Líneas de trabajo (II)}
...
\frame
{
  ...
  \begin{figure}[h]
    \begin{center}
      \includegraphics[scale=0.1267]{images/build/paso2.png}
    \end{center}
  \end{figure}
}
...
\frame
{
  ...
  \begin{itemize}
    ...
    \item<2-> Persistencia de objetos (JDO, Hibernate...)
    \item<3-> Configuración parser XML (runtime)
    \item<4-> i18n + l10n (Java Intl)
    \item<5-> Extración de propiedades para el agrupamiento de palabras 
    \item<6-> Nueva versión del SP (1.6/2007-{\bfseries08}-18)
  \end{itemize}
...
\frame
{
  ...
  \begin{itemize}
    ...
    \item<1-> Utilización de herramientas no usadas en la titulación
    \item<1-> Primer contacto con el mundo de la RI
    \item<1-> Lo más \textit{vistoso} todavía está por implementar
  \end{itemize}
