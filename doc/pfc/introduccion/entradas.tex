\section{Estilo de los ficheros a tratar}

En la siguiente sección se explicarán todos los aspectos relevantes a los
ficheros de entrada que procesará MIEX.

Los ficheros de entrada con los que va a interacturar MIEX están todos en
formato XML, lo cual facilita un poco el tratamiento y análisis del contenido.

\subsection{¿Qué es XML?}

XML, sigla en inglés de eXtensible Markup Language («lenguaje de
...
Fuente: Wikipedia\footnote{http://es.wikipedia.org/wiki/XML}

\subsection{El lenguaje utilizado}

El lenguaje que se define utilizando XML para representar las colecciones
satisface la siguiente plantilla (más conocido por su nombre
