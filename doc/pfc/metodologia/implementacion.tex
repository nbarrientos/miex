...
guardar la información que se capture durante el tratamiento de las colecciones.
...
Como se puede observar, lo que hasta ahora se ha comentado en esta sección no
trata en profundidad cada elemento del código fuente, es decir, no se describen
...
referencia para posteriores usos del proyecto.
