...
sintáctica que el analizador provee, es decir, las etiquetas a nivel de
palabra, a nivel frasal y a nivel clausal.

\item [Semantic]
Esta relación está diseñada para guardar los datos relativos a la información
semántica extraida, en concreto las relaciones gramaticales entre las palabras
(en forma de dependencias).
...
Como se puede figurar después de haber leido el primer capítulo, no es objetivo
