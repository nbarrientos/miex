...
\begin{tabular}{cp{12cm}}
 ...
 \hline
 ParseElement &
 Almacén para cada uno de los elementos del análisis extraídos del árbol
 (ver figura \ref{fig:arbol-sintactico}).\\
 \hline \hline
\end{tabular}

Los atributos que contienen las entidades anteriores son los siguientes:
...
\begin{tabular}{cccl}
 ...
 \hline
 & string & varchar & Contenedor de la palabra\\
 \hline
 Collection & collection\_id & int & Índice\\
 \hline
 & name & varchar & Nombre de la colección\\
 \hline
 ...
 \hline
 & string & varchar & Contenedor del nombre del tipo de documento\\
 \hline
 Category & category\_id & int & Índice\\
 \hline
 & string & varchar & Contenedor del nombre de la categoría\\
 \hline
 Property & property\_id & int & Índice\\
 \hline
 Property & string & varchar & Contenedor del nombre de la propiedad\\
 \hline
 & description & tinytext & Descripción de la propiedad\\
 \hline
 Proptype & proptype\_id & int & Índice\\
 \hline
 & string & varchar & Contenedor del nombre del tipo de la propiedad\\
 \hline
 PropertyList & propertylist\_id & int & Índice\\
 \hline
 & hashCode & char & Hash identificador de la lista\\
 \hline
 ParseElement & element\_id & int & Índice\\
 \hline
 & fromTitle & bool & 1 si el elemento pertenece al título del
 documento\\
 \hline
 & normalized & bool & 1 si el elemento está normalizado\\
 \hline \hline
\end{tabular}
...
apartado sólo se van a comentar la relación \textit{Dependencies}, que puede
ser la que necesite un poco más de explicación.
...
las palabras (véase la figura \ref{fig:relaciones-palabras}).
...
El paso a tablas del modelo E-R da lugar al modelo relacional, posteriormente
utilizado para elaborar la lista de sentencias SQL necesarias para crear la
base de datos.

Para representarlo se utiliza la siguiente leyenda. Si un atributo está en
