...
apartado sólo se va a comentar la relación llamada \textit{dependencies}, que
...
Las tablas que sólo tienen dos atributos y uno de ellos es clave alcanzan
FNBC\footnote{Forma Normal de Boyce-Codd} ya que, están en 3FN\footnote{Tercera
Forma Normal} y en la única dependencia funcional existente el antecedente es
clave primaria.

Las tablas en las que todos sus atributos son clave primaria (doccat y
propproplist) están en FNBC.
...
tablas restantes están en FNBC.
...
Como se puede deducir después de haber leído el primer capítulo, no es objetivo
