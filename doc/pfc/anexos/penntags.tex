...
En el siguiente anexo se explica el significado de cada una de las etiquetas
...
\end{tabular}
\caption{Significado de las etiquetas a nivel de cláusula}
\end{center}
\end{table}
...
\end{tabular}
\caption{Significado de las etiquetas a nivel de frase}
\end{center}
\end{table}
...
38 & WRB & Wh-adverb\\
\end{tabular}
\caption{Significado de las etiquetas a nivel de palabra}
\end{center}
\end{table}
