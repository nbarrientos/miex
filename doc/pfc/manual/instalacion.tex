...
Antes de comenzar la instalación, es necesario descargar todas las dependencias
que son las siguientes. Colocaremos los JAR correspondientes de cada biblioteca
en el directorio \textit{/usr/lib/java}
...
fuente del programa. Para obtenerlo existen varios caminos.
...
Si quiere obtener la última versión del código deberá de instalar antes
